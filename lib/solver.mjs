import { getPossibilities, getFirstEmptyCell, boardError, setCharAt, memoize1, memoize2, memoize3 } from './utils'

const memoizedSetCharAt = memoize3(setCharAt)
const memoizedGetGuesses = memoize1(getGuesses)
const memoizedGetPossibilities = memoize2(getPossibilities)
