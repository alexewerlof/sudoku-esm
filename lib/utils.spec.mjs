...
import { times9, times81, importantCells } from './utils'
...
export function importantCells_is_an_array_of_81_arrays() {
  assert.ok(Array.isArray(importantCells), 'is an array')
  assert.deepEqual(importantCells.length, 81, 'and has 81 elements')
  importantCells.forEach((e, i) => {
